...
show_info() {
    ...
    echo "   • Data Volume: fasttrack-data"
    echo "   • Host Data Path: ./fasttrack-data"
    echo ""
    ...
    echo "   • View data: ls -la ./fasttrack-data/"
    echo "   • Backup data: tar -czf fasttrack-backup-$(date +%Y%m%d).tar.gz ./fasttrack-data/"
    echo ""
}
...
main() {
    ...
    echo ""
    echo "📁 Data Structure:"
    echo "   • Host location: ./fasttrack-data/app_data/"
    echo "   • User accounts: ./fasttrack-data/app_data/users.json"
    echo "   • User sessions: ./fasttrack-data/app_data/sessions.json"
    echo "   • User data: ./fasttrack-data/app_data/users/[username]/"
    echo ""
    echo "💾 Data Persistence:"
    echo "   • All data stored in Docker volume 'fasttrack-data'"
    echo "   • Data survives container restarts and updates"
    echo "   • User accounts persist across browser changes"
    echo "   • Sessions maintained for 30 days"
